...
**Maturity: Early access.** Generates deploy files around pinned Ferrum — protocol logic stays in the Ferrum container. License SPDX **BUSL-1.1** (GitHub may label this Other).
