...
| Co-deploy profiles | [field-edge+infra.toml](../config/profiles/field-edge+infra.toml), [federated-node.toml](../config/profiles/federated-node.toml), [field-edge+solum.toml](../config/profiles/field-edge+solum.toml), [bra-companion.toml](../config/profiles/bra-companion.toml), [institute.toml](../config/profiles/institute.toml) |
