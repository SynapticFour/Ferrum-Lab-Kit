...
fn pi_env_file(
    ...
    out.push_str("# Monolith ARM64 image (override if your registry uses another tag)\n");
    out.push_str("FERRUM_IMAGE=ghcr.io/synapticfour/ferrum:latest-arm64\n");
...
| Network | Needed once to pull `ghcr.io/synapticfour/ferrum:latest-arm64` (and companions) |
...
export FERRUM_IMAGE="${FERRUM_IMAGE:-ghcr.io/synapticfour/ferrum:latest-arm64}"
...
mod tests {
    ...
    fn raspberry_pi_bundle_writes_kit_files() {
        ...
        assert!(env.contains("latest-arm64"));
